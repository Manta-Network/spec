...
\begin{center}
    ...
    \begin{mdframed}[leftmargin=0.125\textwidth, rightmargin=0.125\textwidth]
        \begin{center}
            \begin{tikzcd}
                &  & \sk \arrow[lldd, "(\dash)\,\cdot\,\alpha"'] \arrow[rrdd, "(\dash)\,\cdot\,g"] & & & & & & \\
                & & & & & & & & \\
                \sk_\alpha \arrow[rrdd, "(\dash)\,\cdot\,g"'] & & & & \ak \arrow[lldd, "(\dash)\,\cdot\,\alpha"] \arrow[rr, "\KDF^\vk"] & & \vk \arrow[rr, "(\dash)\,\cdot\,g"] & & \pk \\
                & & & & & & & & \\
                & & \ak_\alpha & & & & & &
\end{tikzcd}
        \end{center}
