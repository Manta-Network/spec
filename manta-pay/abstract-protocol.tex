...
\begin{tikzcd}
\textsf{sk} \arrow[rrr, "\textsf{derive}" description] \arrow[rd, "\textsf{rand}_\alpha" description] &                                                              &  & \textsf{ak} \arrow[rr, "\textsf{KDF}^\textsf{vk}" description] \arrow[d, "\textsf{rand}_\alpha" description] &  & \textsf{vk} \arrow[rr, "\textsf{agree}_\textsf{D}" description] &  & \textsf{pk}_\textsf{D} \\
                                                                                                      & \textsf{sk}_\alpha \arrow[rr, "\textsf{derive}" description] &  & \textsf{ak}_\alpha                                                                                           &  &                                                                 &  &                       
\end{tikzcd}
