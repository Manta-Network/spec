...
Now we can sign this body with $\sk_\alpha : \SpendingKey := \sk \cdot \alpha$ where the signature scheme has $\TransferPostBody$ as the $\SIG.\Message$ type:

\begin{definition}[\Transfer{} Post]
    A \TransferPost{} is the following tuple:
    \begin{align*}
        \sigma &: \Option(\SIG.\Signature) \\
