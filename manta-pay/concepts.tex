...
\begin{center}
    \vspace{1em}
    \begin{mdframed}[leftmargin=0.15\textwidth, rightmargin=0.15\textwidth]
        \begin{center}
            \begin{tikzcd}
