...
\begin{definition}[\Transfer{} Validity \Statement{}]\label{def:transfer-validity-statement}
    ...
    \begin{enumerate}
        ...
        \item For all $(i, R) \in \Enumerate(T.\receivers)$, the \Receiver{} $R$ is well-formed at index $i$ with respect to \FAIR{}:
            \begin{align*}
                R.\esk      &= \COM_{\tau}(\mathcal{L} \,||\, i \,||\, R.\rk.\spend) \\
                R.\trapdoor &= \KA.\agree(R.\esk, R.\rk.\spend) \\
                R.\cm       &= \COM_{R.\trapdoor}(R.\asset.\ID \,||\, R.\asset.\VALUE)
            \end{align*}
            where $\tau \sim \COM.\TrapdoorDistribution$ is a randomly chosen trapdoor and $\mathcal{L}$ is the ledger checkpoint, a constant determined by the current state of the ledger.
    \end{enumerate}
