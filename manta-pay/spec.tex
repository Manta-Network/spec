...
\begin{definitiontoc}{Key-Diversification Scheme}
...
\footnotetext{The key-diversifier is not directly chosen by the ledger participants building the \Transfer{}. Instead, it is derived from other \Transfer{} data and the current state of the ledger. See \autoref{def:transfer-validity-statement} for more.}
