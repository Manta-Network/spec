...
\begin{definitiontoc}{Commitment Schemes}
    ...
    For $\COM^{\EK}$ we use a Poseidon Sponge Commitment ... \TODO{elaborate on this construction}
...
\begin{definitiontoc}{Key-Derivation Functions}
    For $\KDF^{\Trapdoor}$, we use ... \TODO{for hashing: ?}

    For $\KDF$, we use ... \TODO{for encryption: Blake2s with magic-number salt}
\end{definitiontoc}
